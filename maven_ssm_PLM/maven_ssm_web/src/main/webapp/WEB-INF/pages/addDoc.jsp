                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="${pageContext.request.contextPath}/article/saveArticle.do" method="post"
                                      class="row">
                                    <input type="hidden" id="id" name="id" value=""/>
                                    <input type="hidden" id="delstatus" name="delstatus" value="1"/>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="users" name="users" value=""
                                               placeholder="人名"/>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="clearfix">
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input type="radio" name="status" value="0" checked><span>借出</span>
                                            </label>
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input type="radio" name="status" value="1" ><span>归还</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
